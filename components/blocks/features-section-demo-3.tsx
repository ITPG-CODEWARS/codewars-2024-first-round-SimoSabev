...
export default function FeaturesSectionDemo() {
    const features = [
        {
            title: "Accessible web experience on all devices with themeing provided by Trainco",
            description:
        ...
        {
            title: "Our team of employees",
            description:
                "We have team members from all over the world. And are the most executive people in the world.",
            skeleton: <SkeletonTwo/>,
            className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
        },
        {
            title: "Watch more about luxury trains",
            description:
                "We have a youtube videos where you can watch more about luxury trains.",
            skeleton: <SkeletonThree/>,
            className:
                "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
        },
        {
            title: "Easy accessible from all over the world",
            description:
                "With our blazing fast, you receive the product in less than a monnth",
        ...
        <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
            <div className="px-8">
                ...
                <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
                    Trainco provides the best services in the industry. We have a team of over 1000 engineers and
                    designers who are always ready to help you with your project.
                    Also Trainco has the biggest community so you can connect with other users and share your ideas with
                    them.
                </p>
            </div>
...
export const SkeletonThree = () => {
    return (
        <Link
            href="https://www.youtube.com/watch?v=J3s3-Jpx4uk"
            target="__blank"
    ...
    return (
        <div className="relative flex flex-col items-start p-8 gap-10 h-full overflow-hidden">
            ...
            <div className="flex flex-row">
                {[luxury4.src, luxury5.src].map((image, idx) => (
                    <motion.div
